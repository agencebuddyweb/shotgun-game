          ...
          <div className="content has-text-light is-size-5">
            ...
            <form action="">
              <div className="field mb-2">
                <label
                  className="label has-text-weight-bold has-text-light mb-0 is-size-5"
                  >Name of your bot
                  <span className="has-text-danger">*</span></label
                >
                ...
                <div className="control">
                  <div className="file is-boxed is-fullwidth">
                    <label className="file-label">
                      ...
                      <span
                        className="file-name has-text-centered is-flex is-align-items-center is-justify-content-center"
                      >
                        <span> Screen Shot 2017-07-29 at 15.54.25.png </span>
                        <span>
                          <span> -</span>
                          <a className="has-text-danger" href=""> Supprimer </a>
                        </span>
                      </span>
                    </label>
                  </div>
              ...
              <div className="field mb-2">
                ...
                <p className="help">Past here the url of your github gist.</p>
                <p className="mt-2 has-text-weight-bold mb-0">
                  Test your bot during a training session
                </p>
                <div
                  className="buttons is-flex is-align-items-stretch is-justify-content-center"
                >
                  <button className="button is-grey-darker py-3 is-small">
                    <span className="is-size-6"> Dual training VS Neo </span>
                  </button>
                  <button className="button is-grey-darker py-3 is-small">
                    <span className="is-size-6"> Dual training VS J. Wick </span>
                  </button>
                </div>
